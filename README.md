# Functional Python [![](https://github.com/mlcorral/functional-python/workflows/tests/badge.svg)](https://github.com/mlcorral/functional-python/actions?query=workflow%3Atests)
